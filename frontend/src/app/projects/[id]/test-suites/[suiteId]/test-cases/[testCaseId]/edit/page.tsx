...
export default function EditTestCasePage() {
  ...
  const mutation = useMutation({
    mutationFn: (data: FormData) =>
      updateTestCase(projectId, suiteId, testCaseId, data),
    onSuccess: () => {
      router.push(
  ...
  return (
    <div className="container py-10">
      <div className="flex justify-between items-center mb-8">
        <div>
          <h1 className="text-3xl font-bold">テストケースの編集</h1>
          <p className="text-gray-600 mt-2">{testCase.name}</p>
        </div>
      </div>
